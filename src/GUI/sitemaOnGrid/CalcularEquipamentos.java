 ...
 * @author Marlon
 */
public class CalcularEquipamentos extends javax.swing.JFrame {

    /**
     * Creates new form AdicionarEquipamentos
     */
    public CalcularEquipamentos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        add2.setText("Calcular consumo por mês");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(107, 107, 107))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .addComponent(add2, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(75, 75, 75))))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
    ...
    private void add2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add2ActionPerformed
        try {
            ...
            if (energiaTotal > 0) {
                double energiaMes = (energiaTotal * 30)/1000;
                Mensagem m = new Mensagem("A energia consumida por mês: " + energiaMes + " KWh",
                        "Dados do circuito");
                m.setVisible(true);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalcularEquipamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new CalcularEquipamentos().setVisible(true);
        });
    }
